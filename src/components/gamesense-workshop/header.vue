<template>
  <div
    ...
    :class="{
      'workshop-header--minimize': minimize,
      'workshop-header--background': !backgroundless
     }"
    ref="routineHeader"
  >
    <!--    For mobile-->
    <div class="workshop-header--mobile">
      <div class="column">
    ...
    <div class="workshop-header--web">
      <div :class="` row ${ minimize ? 'items-center' : 'items-end'} q-mx-auto`"
        ...
        <div :class="`col-12 col-sm-${minimize ? 6 : 8} col-lg-${minimize ? 6 : 9}  relative-position`">
          <div class="workshop-header__row routine-info routine-info--1">
            <div class="routine-info__item" ref="category">
          ...
          <div class="workshop-header__row q-py-lg">
            <div class="row items-center justify-center justify-md-start ">
              <div class="text-h1 overflow-hidden" ref="title" style="white-space: nowrap;text-overflow: ellipsis">
                {{title}}
              </div>
              <div class="q-ml-md q-mt-sm cursor-pointer" @click="$emit('back')">
                <c-icon icon="goBack" width="42px" />
              </div>
            </div>
          ...
          <div class="workshop-header__row routine-info routine-info--2">
        ...
        <div :class="`col-12 col-sm-${minimize ? 6 : 4} col-lg-${minimize ? 6 : 3}`">
          <div class="workshop-header__row routine-actions"
